...
function doRegister(){
    ...
    let url = urlBase + 'LAMPAPI/RegisterUser.' + extension;
    ...
    try{
        xhr.onreadystatechange = function (){
            ...
            if(this.status == 200){
                ...
                lastName = jsonObject.lastName;
                saveCookie();
                setTimeout(bootBackToLogin,2000);
...
function bootBackToLogin()
{
    document.location.href = "/loginreg.html";
}
...
function validRegister(first, last, user, pass){
    ...
    if(first == ""){
        ...
        document.getElementById("registerFirstNameError").innerHTML ="first name cannot be blank";
    }
    else{
        document.getElementById("registerFirstNameError").innerHTML ="";
        firsterr = false;
    }

    if(last == ""){
        console.log("LAST NAME IS BLANK");
        document.getElementById("registerLastNameError").innerHTML ="last name cannot be blank";
    }
    else{
        document.getElementById("registerLastNameError").innerHTML ="";
        lasterr = false;
    }

    if(user == ""){
        console.log("USERNAME IS BLANK");
        document.getElementById("registerUsernameError").innerHTML ="username cannot be blank";
    }
    else{
        ...
        if(regex.test(user) == false){
            console.log("INVALID USERNAME");
            document.getElementById("registerUsernameError").innerHTML ="invalid username";
        }
        else{
            document.getElementById("registerUsernameError").innerHTML ="";
            console.log("VALID USERNAME");
    ...
    if(pass == ""){
        console.log("PASSWORD IS BLANK");
        document.getElementById("registerPasswordError").innerHTML ="password cannot be blank";
    }
    else{
        ...
        if(regex.test(pass) == false){
            console.log("INVALID PASSWORD");
            document.getElementById("registerPasswordError").innerHTML ="invalid password";
        }
        else{
            document.getElementById("registerPasswordError").innerHTML ="";
            console.log("VALID PASSWORD");
